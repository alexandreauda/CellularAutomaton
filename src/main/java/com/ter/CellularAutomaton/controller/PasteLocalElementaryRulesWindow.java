 ...
 */
public class PasteLocalElementaryRulesWindow implements ActionListener {
	 ...
	 */
	public PasteLocalElementaryRulesWindow(LocalElementaryRulesWindow window) {
		super();
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(m_window.getm_isComponentFocus()[0]){
			m_window.getm_formattedTextFieldX1().replaceSelection("");
			int positionCursor = m_window.getm_formattedTextFieldX1().getCaretPosition();
			String oldText = m_window.getm_formattedTextFieldX1().getText();
			m_window.getm_formattedTextFieldX1().setText(oldText.substring(0, positionCursor) + this.getClipboardContents() + oldText.substring(positionCursor, oldText.length()));
			//m_window.getm_formattedTextFieldX1().insert(this.getClipboardContents(), m_window.getm_formattedTextFieldX1().getCaretPosition());
			//printClipboard();
		}
		else if(m_window.getm_isComponentFocus()[1]){
			m_window.getm_formattedTextFieldX2().replaceSelection("");
			int positionCursor = m_window.getm_formattedTextFieldX2().getCaretPosition();
			String oldText = m_window.getm_formattedTextFieldX2().getText();
			m_window.getm_formattedTextFieldX2().setText(oldText.substring(0, positionCursor) + this.getClipboardContents() + oldText.substring(positionCursor, oldText.length()));
			//m_window.getm_formattedTextFieldX2().insert(this.getClipboardContents(), m_window.getm_formattedTextFieldX2().getCaretPosition());
			//printClipboard();
		}
